...
def about():
	...
	print("")
	print("\t"+P+"Team    "+G+": "+G+"ITALIA"+W+" CYBER"+R+" 😅 - "+P+"INDO Cyber Team")
	print("")
...
def Vandroid():
	...
	print("")
	print(""+R+"[============"+G+"|•|"+GR+"Contact: #"+G+"ITALIA"+GR+"CYBER"+R+" 😅|•|"+R+"===========]")
	print("")
	try:
...
def Vmacosx():
	...
	print("")
	print(""+R+"[==========="+G+"|•|"+GR+"Contact: #"+G+"ITALIA"+GR+"CYBER"+R+"😅|•|"+C+"===========]")
	print("")
	try:
...
def menu():
	...
	print("")
	print(""+R+"[==========="+G+"|•|"+GR+"Contact: #"+G+"ITALIA"+W+"CYBER "+R+"😅|•|"+R+"===========]")
	print("")
	try:
		menu = input("\n "+G+" [★root@viridae★]->> "+B+" ")
		if menu == 1:
